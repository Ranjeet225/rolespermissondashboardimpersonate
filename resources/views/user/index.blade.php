          ...
          <tr>
            ...
            <td>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input flexSwitchCheckChecked" data-id="{{$user->id}}" type="checkbox" role="switch" {{ $user->is_active == '1' ? 'checked' : '' }} disabled>
                </div>
                @else
                    <div class="form-check form-switch">
            ...
            <td>
                @if ($user->hasRole('Administrator'))
                <select class="form-control approve" name="approvevalue" data-id="{{$user->id}}" disabled>
