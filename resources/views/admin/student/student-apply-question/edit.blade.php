        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0"> Student Apply Question</h4>
                </div>
                <div class="card-body">
                    <div class="wizard">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                <div class="mb-4">
                                    <h3>
                                        Edit  Student Apply Question</h3>
                                </div>
                                @if (session('success'))
                                ...
                                @endif
                                <form class="row g-4" action="{{ route('update-student-question',$student_question->id) }}" method="POST"
