    ...
    <div class="card-group">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('visa-sub-document-type')}}" method="get" class="d-flex justify-content-between">
            <div class="col-md-8">
            ...
            <div class="col-md-2 float-start">
                <a href="{{route('visa-sub-document-type')}}" class="btn btn-info px-5 mx-2">
                    Reset
                </a>
            </div>
          </form>
            ...
            <table class="table table-striped custom-table mb-0">
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        @can('visa_sub_document_type.update')
                        <td><a  href="{{route('edit-visa-sub-document-type',$item->id)}}"><i class="fa-solid fa-pen"></i></a></td>
                        @endcan
                        @can('visa_sub_document_type.delete')
                        <td><a href="{{route('delete-visa-sub-document-type',$item->id)}}"><i class="fa-solid fa-trash"></i></a></td>
                        @endcan
                    </tr>
                    @endforeach
                </tbody>
