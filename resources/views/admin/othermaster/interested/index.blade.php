    ...
    <div class="card card-buttons">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="{{ route('create-interested') }}" class="btn add-btn">
    ...
    <div class="card-group">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('interested-filter')}}" method="get" class="d-flex justify-content-between">
            <div class="col-md-8">
            ...
            <table class="table table-striped custom-table mb-0">
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        <td><a  href="{{route('edit-interested',$item->id)}}"><i class="fa-solid fa-pen"></i></a></td>
                        <td><a href="{{route('delete-interested',$item->id)}}"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
