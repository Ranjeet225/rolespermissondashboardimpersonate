    ...
    <div class="card-group">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('visa-document-type')}}" method="get" class="d-flex justify-content-between">
            <div class="col-md-8">
            ...
            <div class="col-md-2 float-start">
                <a href="{{route('visa-document-type')}}" class="btn btn-info px-5 mx-2">
                    Reset
                </a>
            </div>
          </form>
