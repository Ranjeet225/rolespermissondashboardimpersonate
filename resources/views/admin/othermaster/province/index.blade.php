    ...
    <div class="card-group">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('provience-filter')}}" method="get" class="d-flex justify-content-between">
            <div class="col-md-8">
            ...
            <div class="col-md-2 float-start">
                <a href="{{route('provience')}}" class="btn btn-info px-5 mx-2">
                    Reset
                </a>
            </div>
          </form>
            ...
            <table class="table table-striped custom-table mb-0">
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        <td class="text-wrap">{{ $item->province->name }}</td>
