    ...
    <div class="card-group">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('education-level-filter')}}" method="get" class="d-flex justify-content-between">
            <div class="col-md-4">
            ...
            <div class="col-md-3 col-sm-3 float-start">
                <a href="{{route('education-level')}}" class="btn btn-info px-5 mx-2">
                    Reset
                </a>
            </div>
          </form>
