                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                <form class="row g-4" action="{{ route('update-education-level',$educationlevel->id) }}" method="POST"
                                    ...
                                    <div class="col-12">
                                        <label>Name</label>
                                        <input type="text" class="form-control sidfrm" name="name" value="{{$educationlevel->name}}">
                                        @error('name')
                                    ...
                                    <div class="col-12">
                                        <label>Order</label>
                                        <input type="text" name="item_order"  class="form-control sidfrm" value="{{$educationlevel->item_order}}">
                                        @error('order')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
