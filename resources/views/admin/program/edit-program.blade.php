                ...
                <form class="row g-4"  action="{{route('update-program',$program->id)}}" method="POST">
                    ...
                    <div class="col-4">
                       <div class="form-floating">
                          <select class="form-control  " name="programCampus" id="lead-programCampus" placeholder="Courses Campus">
                             ...
                             @foreach(['Online', 'Residential', 'NonResidential'] as $option)
                    ...
                    <div class="col-4">
                       <div class="form-floating">
                          ...
                          <label for="lead-lang_spec_for_program" class="form-label">Language Specification For Program / Courses <span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="col-12">
                       <label>Description</label>
                        <textarea name="details" id="summernote1" cols="30" rows="10">{!! old('details') ?? $program->details !!}</textarea>
                    </div>
