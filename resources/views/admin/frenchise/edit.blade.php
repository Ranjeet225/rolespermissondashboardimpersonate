                    ...
                    <form id="company_info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="file" class="form-control" name="business_certificate" id="business_certificate">
                                <span class="text-danger error-bussines-certificate"></span>
                            </div>
                        </div>
                    </form>
                    <div class="d-flex">
                        <a class="btn btn btn-primary next  px-4" id="tab1datasubmit">
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="phone"  value="{{$frenchise->phone ??  old('phone')}}" placeholder="Enter phone">
                ...
                <div class="card-body myform">
                    <form action="{{route('frenchise-store')}}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                           ...
                           <br>
                           <div class="col-md-12">
                              <button type="submit" class="btn btn-info submitButton w-25 align-center" >Submit</button>
                           </div>
                        </div>
                     </form>
                </div>
