            ...
            @foreach ($verticalMenuData[0]->menu as $menu)
                ...
                @if($permissionCondition)
                    @if(!($user->hasRole('student')))
                        @if($menu->permission== 'my_profile.view' || $menu->permission== 'applied_program.view' || $menu->permission == 'oel_apply.view' || $menu->permission== 'check_eligibility.view' || $menu->permission == 'my_profile.update')
                            @continue
                        @endif
                    @endif
