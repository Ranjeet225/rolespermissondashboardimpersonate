        ...
        <div class="card-group">
            <div class="card">
                <div class="card-body myform">
                    <form action="{{ route('message-frenchise') }}" method="GET">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-2 ">
                                    <a href="{{ route('message-frenchise') }}" class="btn btn-info d-lg-block  formmrgin ">Reset
                                    </a>
                                </div>
                                <div class="col-md-1 ">
                    ...
                    <tbody id="lead-list">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                aria-controls="sms-list"><i class="las la-list-alt sms_list" style="color: red;" data-id ="{{$item->phone}}"></i></a>
                            </td>
                            <td>
                                <a href="" class="btn-sm mx-1" class="last_attended" data-tour="search"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.error-message').html('');
                ...
                $.ajax({
                    url: "{{ route('send-email-frenchise') }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
