...
@section('content')
    ...
    <div class="main-content">
        ...
        <div id="rs-about" class="rs-popular-courses style3 pb-40 pt-100 md-mt--140 md-pt-70 md-pb-30">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="consultant-info-div ">
                            ...
                            <p class="about-content">Students are required to give language proficiency tests to demonstrate
                                the institution that candidates have adequate level of knowledge of that language to cope up
                                with the college lectures. These tests are mandatory part of the application.</p>
                            <!--
                                <p>
           ...
           -->
                            <b>GMAT:-</b>
                            <p>This exam is taken by applicants who want to apply to business schools. Applicants are tested
                                on their mathematical, analytical, and verbal skills. The main purpose of this exam is to
                                assess the applicants' ability to study in a business school. GMAT aspirants can apply for
                                more than 7000 programs at around 2300 business schools worldwide.</p>
                            <!--
    ...
    The main purpose of this exam is to evaluate the aspirants' ability to study at a business school. Top business schools across the world like Harvard, INSEAD and Stanford accept the GMAT score of above 720.</p>
                            ...
                            <b>GRE:-</b>
                            <p>The GRE General Test is the world's largest standardized test taken by students for
                                undergraduate admission. It assesses candidate’s ability to pursue graduation in a variety
                                of streams. It assesses applicant’s skills in analytical, quantitative, and verbal
                                reasoning. The GRE General Test is accepted by thousands of graduate schools around the
                                world.</p>
                            <!--
    ...
    This exam is given by students who want to secure admission in graduate programs across all the disciplines. It evaluates candidates' ability in analytical, quantitative and verbal reasoning. Apart from this, who wants to study particular subjects also give the GRE Subject test.</p>
                            ...
                            <b>TOEFL:-</b>
                            <p>The TOEFL exam is taken by those who want to go to a country where English is the main
                                language of communication. TOEFL scores are accepted by more than 10,000 educational
                                institutions, including colleges, universities, and other institutions worldwide. This test
                                is used to assess the applicant's English proficiency.</p>
                            <p>Getting the maximum score in these pre- admissions tests require guidance and a plan of
                                action. We connect students with the most qualified IELTS and TOEFL instructors who can
                                assist them in scoring good.</p>
