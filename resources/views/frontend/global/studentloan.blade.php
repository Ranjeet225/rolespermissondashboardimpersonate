    ...
    <div class="main-content">
        ...
        <div class="rs-breadcrumbs breadcrumbs-overlay">
            <div class="breadcrumbs-img">
                <img src="{{ asset('public/pages/about_us/about_us_banner.jpg') }}" alt="Breadcrumbs Image">
            </div>
            <div class="breadcrumbs-text white-color">
                <!-- <h1 class="page-title">Home</h1> -->
                <h4 class="dn-about"> Student Loan </h4>
                                ...
                                <div class="tab-pane tab fade active show" id="prod-overview" role="tabpanel"
                                    ...
                                    <div class="content pt-30 pb-30 pl-30 pr-30 white-bg pb-30 pl-30 pr-30 white-bg">
                                        ...
                                        <div class="course-overview">
                                            <img src="{{ asset('public/images/s2.png') }}" />
                                            <div>

                                                <p>Studying abroad at a top university is every student’s dream but having
                                                    finances to study abroad might be a little s exorbitant. Almost everyone
                                                    seeks an education loan for study abroad. However, having finances to go
                                                    overseas might be a little exorbitant for the students.

                                                </p>
                                                <p>We are an elite portal that provides the greatest financial choices for
                                                    international education seekers looking to carve out a place
                                                    academically. Our sole goal is to provide financial assistance to
                                                    international students at all levels, whether it is for Undergraduate or
                                                    Postgraduate studies in the most sought-after study destinations such as
                                                    the United States, the United Kingdom, Canada, Australia, New Zealand,
                                                    Ireland, Europe, Singapore, Dubai, or any other country of the students'
                                                    choice. Our Education Loan Experts not only help students choose the
                                                    proper financial institution, but they also help them from application
                                                    to loan disbursement through our Banking Partners. OEL is the best Study
                                                    Abroad Funding Solution due to a thorough combination of knowledge and
                                                    technology. </p>
                                                ...
                                                <div class="consultant-info-div">
                                                    ...
                                                    <ul class="detail-list">
                                                        ...
                                                        <li>ACT Test Dates</li>
                                                        <li>All co-applicants must be Indian citizens.</li>
                                                        <li> Capability to provide collateral in certain instances</li>
                                                        <li>ACT Exam Fee </li>
                                                        <li> The co-borrower must have a bank account in any bank in India
                                                            that offers check writing services. </li>
                                                ...
                                                <div class="consultant-info-div">
                                                    ...
                                                    <ul class="detail-list">
                                                        ...
                                                        <li> Academic Documents of Student</li>
                                                        <li>Proof of Admission (If available)</li>
                                                        <li> Last 8 Months Bank Statements of Co-Applicant </li>
